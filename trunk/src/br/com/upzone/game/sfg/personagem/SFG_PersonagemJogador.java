...
public class SFG_PersonagemJogador extends GjME_Personagem
  ...
  public SFG_PersonagemJogador(int iTelaLargura, int iTelaAltura) throws IOException {
    ...
    this.addEstado(SFG_PersonagemJogador.EST_PERSON_PARADO,
      new GjME_Estado(this, SFG_PersonagemJogador.EST_PERSON_PARADO, 0, 5) {
        public void executeNoEstado() {}});

    // -- Adição do estado ANDANDO
    this.addEstado(SFG_PersonagemJogador.EST_PERSON_ANDANDO,
      new GjME_Estado(this, SFG_PersonagemJogador.EST_PERSON_ANDANDO, 7, 11) {
        public void executeNoEstado() {
          this.personagem.deslocarNaHorizontal();
        }});

    // -- Adição do estado VIRANDO
    this.addEstado(SFG_PersonagemJogador.EST_PERSON_VIRANDO,
      new GjME_Estado(this, SFG_PersonagemJogador.EST_PERSON_VIRANDO, 6, 6) {
        public void executeNoEstado() {}});
